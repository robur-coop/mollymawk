                                           ...
                                           ~a:
                                             [
                                               ...
                                               Unsafe.string_attrib ":class"
                                                 "sortBy === 'Host Device' ? 'border-b-2 border-primary-500 text-primary-800 bg-primary-100' : 'hover:bg-primary-100 text-primary-600'";
                                               a_class
                                                 [
                                           ...
                                           ~a:
                                             [
                                               Unsafe.string_attrib "x-on:click"
                                                 "sortByColumn";
                                               Unsafe.string_attrib ":class"
                                                 "sortBy === 'Size (MB)' ? 'border-b-2 border-primary-500 text-primary-800 bg-primary-100' : 'hover:bg-primary-100 text-primary-600'";
                                               a_class
                                                 [
                                                   "px-6 py-3 text-start \
                                                    text-xs font-bold \
                                           ...
                                           ~a:
                                             [
                                               Unsafe.string_attrib "x-on:click"
                                                 "sortByColumn";
                                               Unsafe.string_attrib ":class"
                                                 "sortBy === 'Used' ? 'border-b-2 border-primary-500 text-primary-800 bg-primary-100' : 'hover:bg-primary-100 text-primary-600'";
                                               a_class
                                                 [
                                                   "px-6 py-3 text-start \
                                                    text-xs font-bold \
